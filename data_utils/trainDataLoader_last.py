...
class trainDataLoader(Dataset):
    ...
    def _get_item(self, index):
        ...
        pointcloud=np.zeros((1,self.num,6))
        ...
        for idx in range(rangenum):
            ...
            pointcloud[0,:,:3]=pointxyz[randomlist]
            pointcloud[0,:,3:]=pointcolor[randomlist]
            ...
            if idx ==0:
                ...
                gt_xyz[0,:]=np.dot(np.linalg.inv(odometry),np.array([first[0], first[1], first[2], 1]))[:3]
